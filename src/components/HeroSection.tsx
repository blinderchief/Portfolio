        ...
        <div className="flex flex-col items-start max-w-5xl mx-auto">
          ...
          <div className="text-reveal-container mb-8 w-full max-w-2xl">
            <div className="text-reveal animate-on-scroll reveal-4 flex gap-3 text-sm text-muted-foreground/80">
              <a href="https://github.com" className="hover:text-primary transition-colors duration-200 border-b border-transparent hover:border-primary">GitHub</a>
              <span>•</span>
              <a href="https://linkedin.com" className="hover:text-primary transition-colors duration-200 border-b border-transparent hover:border-primary">LinkedIn</a>
              <span>•</span>
              <a href="https://codeforces.com" className="hover:text-primary transition-colors duration-200 border-b border-transparent hover:border-primary">CodeForces</a>
              <span>•</span>
              <a href="mailto:mail-to" className="hover:text-primary transition-colors duration-200 border-b border-transparent hover:border-primary">Contact</a>
            </div>
          </div>
