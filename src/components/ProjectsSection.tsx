...
const projects: Project[] = [
  ...
  {
    title: "Dynamic Rumour Spread Network Analyser",
    description: "Designed a system to analyze the spread of rumours on social media using graph-based models and time-series analysis. Tracked temporal evolution to identify key influencers.",
    technologies: ["Python", "NetworkX", "SciPy", "TensorFlow", "Graph Analysis"],
    link: "#"
  },
  {
    title: "AI-Powered Health & Fitness App (BLINDERFIT)",
    description: "Developing an AI-driven health and fitness app with personalized nutrition plans and e-commerce integration using the DeepMind API.",
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, index) => {
              ...
              } else if (project.title === "Sentiment Analysis of Political Tweets") {
                imagePath = "/sentimentanalysis.png";
              } else if (project.title === "Dynamic Rumour Spread Network Analyser") {
                imagePath = "/dynamicrumour.png";
